...
### 3.FedAvg 5节点联邦训练loss变化
round 1: 0.12426
round 2: 0.05010
round 3: 0.02870
round 4: 0.01987
round 5: 0.01533
![5节点联邦训练日志截图](../assets/week2_fed_5client.png)

对比分析
单机训练（1 客户端）最终损失 0.01856；2 节点联邦 0.01915；5 节点联邦 0.01533；
2 节点损失略高于单机：两个客户端数据分布差异小，新增数据增益有限；
5 节点损失显著更低：融合 5 份不同分布的工业边缘数据，模型泛化能力、拟合效果明显提升；
验证 FedAvg 优势：在多 Non-IID 边缘节点场景，融合更多本地私有数据可降低全局预测损失。
...
FedAvg联邦训练(client_1~5),5,5,0.015325
